...
import { resolvePath } from '@canopy-code/canopy-code-core';
import {
      ...
      if (trustedFolders.isPathTrusted(realTargetPath) !== true) {
        ...
        if (
          ...
          return {
            ...
            prompt: `Move this session to ${realTargetPath}? Canopy Code will be able to read, edit, and execute files there. This folder will be trusted for future sessions.`,
            originalInvocation: {
              raw: rawInvocation,
            },
          };
