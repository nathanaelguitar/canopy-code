...
// Русский перевод для Canopy Code CLI
...
export default {
  ...
  'for help on Canopy Code': 'Справка по Canopy Code',
  ...
  'Analyzes the project and creates a tailored CANOPY.md file.':
    'Анализ проекта и создание адаптированного файла CANOPY.md',
  'List available Canopy Code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов Canopy Code. Использование: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.canopy/settings.json directly to manage skills at user scope.':
    'Рабочая область не является доверенной; настройки рабочей области игнорируются объединённой конфигурацией. Сначала выполните /trust или отредактируйте ~/.canopy/settings.json напрямую, чтобы управлять навыками на уровне пользователя.',
  ...
  'All available skills are disabled. Edit ~/.canopy/settings.json or .canopy/settings.json (skills.disabled) to re-enable.':
    'Все доступные навыки отключены. Отредактируйте ~/.canopy/settings.json или .canopy/settings.json (skills.disabled), чтобы снова их включить.',
  ...
  Bundled: 'Встроенный',
  'Available Canopy Code CLI tools:': 'Доступные инструменты Canopy Code CLI:',
  ...
  'open full Canopy Code documentation in your browser':
    'Открытие полной документации Canopy Code в браузере',
  ...
  // ============================================================================
  'Project Level (.canopy/agents/)': 'Уровень проекта (.canopy/agents/)',
  'User Level (~/.canopy/agents/)': 'Уровень пользователя (~/.canopy/agents/)',
  ...
  'Generate with Canopy Code (Recommended)':
    'Сгенерировать с помощью Canopy Code (Рекомендуется)',
  ...
  'View and edit Canopy Code settings':
    'Просмотр и изменение настроек Canopy Code',
  Settings: 'Настройки',
  'To see changes, Canopy Code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить Canopy Code. Нажмите r для выхода и применения изменений.',
  // ============================================================================
  // Метки настроек
  // ============================================================================
  'Vim Mode': 'Режим Vim',
  ...
  'How is Canopy doing this session? (optional)':
    'Как дела у Canopy в этой сессии? (необязательно)',
  Bad: 'Плохо',
  Fine: 'Нормально',
  Good: 'Хорошо',
  Dismiss: 'Отклонить',
  ...
  'Respect .canopyignore': 'Учитывать .canopyignore',
  ...
  'This extension will append info to your CANOPY.md context using {{fileName}}':
    'Это расширение добавит информацию в ваш контекст CANOPY.md с помощью {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Canopy Code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с Canopy Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Canopy Code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите Canopy Code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Canopy Code hooks': 'Управлять хуками Canopy Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Canopy Code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите Canopy Code.',
  ...
  'To add hooks, edit settings.json directly or ask Canopy.':
    'Чтобы добавить хуки, отредактируйте settings.json напрямую или спросите Canopy.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Canopy to help.':
    'Чтобы изменить или удалить этот хук, отредактируйте settings.json напрямую или спросите Canopy.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Canopy Code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите Canopy Code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  Skill: 'Навык',
  ...
  'Right before Canopy Code concludes its response':
    'Непосредственно перед завершением ответа Canopy Code',
  ...
  'stdout shown to Canopy': 'stdout показан Canopy',
  ...
  'Generate a project summary and save it to .canopy/PROJECT_SUMMARY.md':
    'Сгенерировать сводку проекта и сохранить её в .canopy/PROJECT_SUMMARY.md',
  ...
  'Successfully added CANOPY.md files from the following directories if there are:\n- {{directories}}':
    'Успешно добавлены файлы CANOPY.md из следующих директорий (если они есть):\n- {{directories}}',
  ...
  'Canopy OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Бесплатный уровень Canopy OAuth прекращён 2026-04-15. Выберите Coding Plan или API Key.',
  'Canopy OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Бесплатный уровень Canopy OAuth был прекращен 2026-04-15. Пожалуйста, выберите модель от другого провайдера или выполните /auth для переключения.',
  '\n⚠ Canopy OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Бесплатный уровень Canopy OAuth прекращён 2026-04-15. Выберите другую опцию.\n',
  ...
  'Canopy OAuth Authentication': 'Авторизация Canopy OAuth',
  ...
  'Canopy OAuth Authentication Timeout': 'Таймаут авторизации Canopy OAuth',
  ...
  'Waiting for Canopy OAuth authentication...':
    'Ожидание авторизации Canopy OAuth...',
  ...
  'Invalid CANOPY_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Неверное значение CANOPY_DEFAULT_AUTH_TYPE: "{{value}}". Допустимые значения: {{validValues}}',
  // ============================================================================
  // Диалоги - Модель
  // ============================================================================
  ...
  "Canopy Code won't ask before using allowed tools.":
    'Canopy Code не будет спрашивать перед использованием разрешённых инструментов.',
  'Canopy Code will ask before using these tools.':
    'Canopy Code спросит перед использованием этих инструментов.',
  'Canopy Code is not allowed to use denied tools.':
    'Canopy Code не может использовать запрещённые инструменты.',
  ...
  'Checked in at .canopy/settings.json':
    'Зафиксировано в .canopy/settings.json',
  'User settings': 'Пользовательские настройки',
  'Saved in at ~/.canopy/settings.json': 'Сохранено в ~/.canopy/settings.json',
  ...
  'Canopy Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Canopy Code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'Canopy Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Canopy Code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'You can run any shell commands from Canopy Code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в Canopy Code с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running canopy --continue or canopy --resume.':
    'Вы можете продолжить предыдущий разговор, запустив canopy --continue или canopy --resume.',
  ...
  'Add a CANOPY.md file to give Canopy Code persistent project context.':
    'Добавьте файл CANOPY.md, чтобы предоставить Canopy Code постоянный контекст проекта.',
  ...
  'Run canopy --debug to see error logs':
    'Запустите canopy --debug для просмотра журналов ошибок',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Навигация | Enter: Выбор | Esc: Отмена',
  'Authenticate using Canopy OAuth': 'Аутентификация через Canopy OAuth',
  ...
  'Starting Canopy OAuth authentication...':
    'Запуск аутентификации Canopy OAuth...',
  'Successfully authenticated with Canopy OAuth.':
    'Успешная аутентификация через Canopy OAuth.',
  'Failed to authenticate with Canopy OAuth: {{error}}':
    'Ошибка аутентификации через Canopy OAuth: {{error}}',
  ...
  '  canopy auth canopy-oauth     - Authenticate with Canopy OAuth (discontinued)':
    '  canopy auth canopy-oauth     - Аутентификация через Canopy OAuth (прекращено)',
  'Or simply run:': 'Или просто выполните:',
  '  canopy auth                - Interactive authentication setup\n':
    '  canopy auth                - Интерактивная настройка аутентификации\n',
  '✓ Authentication Method: Canopy OAuth':
    '✓ Метод аутентификации: Canopy OAuth',
  ...
  'Canopy OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Бесплатный уровень Canopy OAuth прекращён 2026-04-15. Выполните /auth для переключения на Coding Plan, OpenRouter, Fireworks AI или другого провайдера.',
  ...
  '  Run `canopy auth coding-plan` to re-configure.\n':
    '  Выполните `canopy auth coding-plan` для повторной настройки.\n',
  ...
  "Set up Canopy Code's status line UI":
    'Настроить интерфейс строки состояния Canopy Code',
  ...
  'Check for Canopy Code updates and install if available':
    'Проверить обновления Canopy Code и установить при наличии',
  'Canopy Code update available! {{current}} → {{latest}}':
    'Доступно обновление Canopy Code! {{current}} → {{latest}}',
  'A new version of Canopy Code is available! {{current}} → {{latest}}':
    'Доступна новая версия Canopy Code! {{current}} → {{latest}}',
  'Canopy Code {{version}} is up to date!': 'Canopy Code {{version}} актуален!',
  ...
  'Update successful! Please restart Canopy Code to use the new version. Switching model providers before restarting may not work correctly.':
    'Обновление успешно! Перезапустите Canopy Code, чтобы использовать новую версию. Переключение поставщиков моделей до перезапуска может работать некорректно.',
  ...
  'Manual update required. Please reinstall Canopy Code.':
    'Требуется ручное обновление. Переустановите Canopy Code.',
  'This session uses the custom sandbox image {{image}}. Update that image and restart Canopy Code.':
    'В этом сеансе используется пользовательский образ песочницы {{image}}. Обновите образ и перезапустите Canopy Code.',
  'Update Canopy Code on the host, then restart the sandbox.':
    'Обновите Canopy Code на хосте, затем перезапустите песочницу.',
