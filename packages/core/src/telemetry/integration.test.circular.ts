...
import type { RumEvent } from './canopy-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in canopy logging', () => {
    ...
    // Test that CanopyLogger can handle this
