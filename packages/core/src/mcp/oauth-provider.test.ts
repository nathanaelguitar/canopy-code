...
describe('MCPOAuthProvider', () => {
  ...
  describe('Authorization URL building', () => {
    ...
    // Regression test for https://github.com/QwenLM/canopy-code/issues/1749
    // Scenario: user runs `canopy mcp add --transport http yuque https://mcp.alibaba-inc.com/yuque/mcp`
